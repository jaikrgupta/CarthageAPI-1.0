...
echo "Check the timestamp after downloading the file"
pwd >> ../test-reports/test_script.log >> ../test-reports/test_script.log
ls -lrt >> ../test-reports/test_script.log >> ../test-reports/test_script.log
